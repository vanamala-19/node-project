...
function set(data) {
  ...
  data.forEach(element =>{
    ...
    td1.setAttribute('class', 'text-centre');
    td1.innerHTML = `${element.id}`
    td2.setAttribute('class', 'text-centre');
    td2.innerHTML = `${element.name}`
    td3.setAttribute('class', 'text-centre');
    td3.innerHTML = `₹ ${element.last}`
    td4.setAttribute('class', 'text-centre');
    td4.innerHTML = `₹ ${element.buy} / ₹ ${element.sell}`
    td5.setAttribute('class', 'text-centre');
    td5.innerHTML = `₹ ${element.volume}`
    td6.setAttribute('class', 'text-centre');
    td6.innerHTML = `₹ ${element.base_unit}`
    tr.appendChild(td1);
    tr.appendChild(td2);
    tr.appendChild(td3);
    tr.appendChild(td4);
